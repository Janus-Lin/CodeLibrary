...
# 解决中文乱码问题
myfont = matplotlib.rc("font", family='Microsoft YaHei')
...
def pie_plot():
    ...
    # 画饼状图
    patches, l_text, p_text = plt.pie(sizes, explode=explode, labels=labels, colors=colors, autopct="%1.1f%%",
...
def three_dimension_bar():
    ...
    # 生成画布(两种形式)
    fig = plt.figure()
    ax = fig.gca(projection="3d", title="plot title1")
